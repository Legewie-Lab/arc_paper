...
% Run two-step RON model fitting as a SLURM array job.
...
%% --- load compiled model ---
load(fullfile(proj_root, 'RON_twostep_compiled.mat'), 'ar');

%% --- load old result ONLY for bounds ---
S = load(fullfile(proj_root, 'RON_Hek293_2_1000.mat'), 'ar');
old_ar = S.ar;
...
outfile = fullfile(result_dir, ...
    sprintf('RON_twostep_LHS_batch_%02d.mat', task_id));

save(outfile, 'ar');

fprintf('Saved results to %s\n', outfile);
fprintf('LHS batch %d finished.\n', task_id);
